...
// Import the app directly - it won't start a server when imported
...
describe('Integration Tests', () => {
  beforeAll(() => {
    ...
    // Allow all localhost connections (supertest uses random ports)
    nock.enableNetConnect((hostname) => {
      return hostname === 'localhost' || hostname === '127.0.0.1' || hostname.startsWith('127.0.0.1');
    });
  });
